...
public:
    ...
    void playWordle() {
        ...
        cout << "🟩 = Correct letter in correct position\n";
        cout << "🟨 = Correct letter in wrong position\n";
    ...
    void playHangman() {
        ...
        if (guessed == word) {
            cout << "🎉 Congratulations! You guessed: " << word << "\n";
        } else {
    ...
    void playRockPaperScissors() {
        ...
        while (playerScore < 3 && computerScore < 3) {
            ...
            cout << "You chose: " << emojis[playerChoice] << " " << choices[playerChoice] << "\n";
            cout << "Computer chose: " << emojis[computerChoice] << " " << choices[computerChoice] << "\n";
        ...
        if (playerScore > computerScore) {
            cout << "🏆 You won the game! Final Score: " << playerScore << "-" << computerScore << "\n";
        } else {
            cout << "💻 Computer won the game! Final Score: " << computerScore << "-" << playerScore << "\n";
        }
    }
    ...
    void playContexto() {
        ...
        while (attempts > 0) {
            ...
            if (hintIndex < hints[word].size()) {
                cout << "💡 Hint: " << hints[word][hintIndex] << "\n";
            }
            ...
            if (similarity > word.length() / 2) {
                cout << "🔥 Very close! You're on the right track!\n";
            } else if (similarity > 0) {
                cout << "🟡 Some letters match, but not quite there!\n";
            } else {
                cout << "❄️ Not close at all, try thinking differently!\n";
            }
    ...
    void playMadLibs() {
        ...
        cout << "!\n\n";
        cout << "🎉 Hope you enjoyed your silly story!\n";
    }
        ...
        while (attempts < max_attempts) {
            ...
            if (guess == secret_number) {
                ...
                if (secret_number - guess > 20) {
                    cout << "📈 Too low! Way too low!\n";
                } else if (secret_number - guess > 10) {
                    cout << "📈 Too low! Getting warmer though!\n";
                } else {
                    cout << "📈 Too low! Very close!\n";
                }
            } else {
                if (guess - secret_number > 20) {
                    cout << "📉 Too high! Way too high!\n";
                } else if (guess - secret_number > 10) {
                    cout << "📉 Too high! Getting warmer though!\n";
                } else {
                    cout << "📉 Too high! Very close!\n";
                }
            }
            cout << "\n";
        }
    ...
    void playWouldYouRather() {
        ...
        for (int round = 1; round <= rounds; round++) {
            ...
            if (choice == 1) {
                cout << "🎭 You chose: " << question.first << "\n";
            } else if (choice == 2) {
                cout << "🎭 You chose: " << question.second << "\n";
            } else {
                cout << "🤷 Invalid choice! Let's say you chose option 1!\n";
            }
        ...
        cout << "🎉 Thanks for playing Would You Rather!\n";
    ...
    void playPong() {
        ...
        displayBoard();
        if (playerScore > computerScore) {
            cout << "🏆 You won! Final Score: " << playerScore << "-" << computerScore << "\n";
        } else {
            cout << "💻 Computer won! Final Score: " << computerScore << "-" << playerScore << "\n";
        }
    }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    cout << "\n👋 Thanks for playing PlayWare! See you next time!\n";
                    return;
                default:
